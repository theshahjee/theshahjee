...
I design and ship AI systems end to end. Architecture, backend, ML pipelines, frontend, cloud. Most of my work sits at the intersection of LLMs, real time systems, and business automation.

My bar is production. I care about systems that survive real traffic, real users, and real edge cases, not prototypes that crack the first time something unexpected happens. Every project below runs in production with paying users or measurable outcomes behind it.
...
I build systems the way I would want to inherit them. Clear architecture, honest documentation, strong observability, code that reads like the engineer cared whether the next person could ship without rewriting everything.

I prefer small sharp teams over large ones, and shipping over meetings. I write directly, move quickly, and take ownership from problem definition through production deployment.
